...
cp "$SCRIPT_DIR/dependencies.sh" "$OUTDIR/rootfs/home/"
cp "$SCRIPT_DIR/start-qemu-app.sh" "$OUTDIR/rootfs/home/"
cp "$SCRIPT_DIR/start-qemu-terminal.sh" "$OUTDIR/rootfs/home/"
